...
3. **Linear State Enforcement:** Pastikan setiap logika kode mematuhi alur: Registrasi -> Baseline Lock (Denominator) -> Submitter (Claim) -> Reviewer (Verify -> Calc) -> Publish. Data identitas TIDAK BOLEH diubah setelah Baseline Lock.
