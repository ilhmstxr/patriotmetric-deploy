...
- **Compro_Page**: Halaman company profile publik yang dapat diakses pengunjung (welcome, profile, visi-misi, tim, penghargaan, panduan, pengumuman)
...
| Section | Konten | Tipe |
|---------|--------|------|
| Hero | Judul utama, deskripsi | Static_Content |
| Hero | Background image | Static_Content |
| About | Judul, deskripsi (1 field rich text gabungan paragraf + bullet points) | Static_Content |
| About | URL video YouTube | Static_Content |
| Institusi Partisipan | Judul section, deskripsi section | Static_Content |
| Institusi Partisipan | Daftar institusi baris 1 (nama, logo) | Repeater_Content |
| Institusi Partisipan | Daftar institusi baris 2 (nama, logo) | Repeater_Content |
| Timeline | Judul section, deskripsi section | Static_Content |
| Timeline | Daftar timeline (nomor, tanggal, judul, deskripsi, artikel terkait) | Repeater_Content |
| Instagram | Judul section, deskripsi | Static_Content |
...
| Hero | Background image | Static_Content |
| Latar Belakang | Judul section, deskripsi (1 field rich text gabungan semua paragraf) | Static_Content |
...
| Daftar Penerima | Daftar institusi penerima (nama, logo, rating bintang) | Repeater_Content |
...
| Section | Konten | Tipe |
|---------|--------|------|
| Hero | Judul ("Pengumuman"), deskripsi | Static_Content |
| Artikel | Daftar artikel (tanggal, judul, excerpt/ringkasan, gambar thumbnail) | Repeater_Content |
...
1. THE Admin_Panel SHALL organize CMS content into separate tabs or navigation items for each Compro_Page (Welcome, Profile, Visi-Misi, Tim, Penghargaan, Panduan, Pengumuman).
...
1. WHEN the CMS seeder is executed, THE CMS SHALL create Content_Block records for all 7 Compro_Pages (Welcome, Profile, Visi-Misi, Tim, Penghargaan, Panduan, Pengumuman) covering both Static_Content and Repeater_Content items as defined in the "Daftar Konten yang Dapat Dikelola via CMS" specification.
