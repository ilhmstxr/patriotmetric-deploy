<footer class="bg-[#D0B55E] overflow-hidden relative w-full">
    <div class="max-w-[1536px] mx-auto px-8 pt-16 pb-0 flex flex-col gap-16">
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-3">
                    <a href="{{ url('/') }}" class="flex items-center gap-3.5">
                        ...
                        <span class="font-['Plus_Jakarta_Sans',sans-serif] font-normal leading-[20px] text-[14px] text-[#286D25]">Beranda</span>
                    </a>
                    <a href="{{ url('/profile') }}" class="flex items-center gap-3.5">
                        <div class="bg-[#1B5E20] rounded-full size-[6px] shrink-0"></div>
                        <span class="font-['Plus_Jakarta_Sans',sans-serif] font-normal leading-[20px] text-[14px] text-[#286D25]">Tentang Kami</span>
                    </a>
                    <a href="{{ url('/pemenang') }}" class="flex items-center gap-3.5">
                        <div class="bg-[#1B5E20] rounded-full size-[6px] shrink-0"></div>
                        <span class="font-['Plus_Jakarta_Sans',sans-serif] font-normal leading-[20px] text-[14px] text-[#286D25]">Pemenang</span>
                    </a>
                    <a href="{{ url('/panduan') }}" class="flex items-center gap-3.5">
                        <div class="bg-[#1B5E20] rounded-full size-[6px] shrink-0"></div>
                        <span class="font-['Plus_Jakarta_Sans',sans-serif] font-normal leading-[20px] text-[14px] text-[#286D25]">Panduan</span>
                    </a>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-4">
                    <div class="flex gap-3 items-start">
                        <svg class="shrink-0 size-5 mt-0.5" fill="none" viewBox="0 0 20 20">
                            <path d="M17.5 8.33333C17.5 14.1667 10 19.1667 10 19.1667C10 19.1667 2.5 14.1667 2.5 8.33333C2.5 6.34421 3.29018 4.43655 4.6967 3.03003C6.10322 1.62351 8.01088 0.833332 10 0.833332C11.9891 0.833332 13.8968 1.62351 15.3033 3.03003C16.7098 4.43655 17.5 6.34421 17.5 8.33333Z" stroke="#1B5E20" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.66667" />
                            <path d="M10 10.8333C11.3807 10.8333 12.5 9.71404 12.5 8.33333C12.5 6.95262 11.3807 5.83333 10 5.83333C8.61929 5.83333 7.5 6.95262 7.5 8.33333C7.5 9.71404 8.61929 10.8333 10 10.8333Z" stroke="#1B5E20" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.66667" />
                        </svg>
                        <p class="font-['Plus_Jakarta_Sans',sans-serif] font-normal leading-[20px] text-[14px] text-[#286D25]">
        ...
        {{-- Bottom Bar --}}
        <div class="flex items-center justify-between py-4 border-t border-[#286D25]">
            <p class="font-['Plus_Jakarta_Sans',sans-serif] font-normal leading-[20px] text-[14px] text-[#286D25]">
                &copy; {{ date('Y') }} Patriot Metric - Universitas Pembangunan Nasional "Veteran" Jawa Timur. Hak Cipta Dilindungi.
            </p>
            <div class="flex gap-4 items-center">
                <span class="font-['Plus_Jakarta_Sans',sans-serif] font-normal leading-[20px] text-[14px] text-[#286D25]">Syarat &amp; Ketentuan</span>
                <span class="font-['Plus_Jakarta_Sans',sans-serif] font-normal leading-[20px] text-[14px] text-[#286D25]">&bull;</span>
                <span class="font-['Plus_Jakarta_Sans',sans-serif] font-normal leading-[20px] text-[14px] text-[#286D25]">Kebijakan Privasi</span>
            </div>
        </div>
    </div>
</footer>
