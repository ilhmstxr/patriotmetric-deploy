    ...
    <div class="flex h-[65px] items-center justify-between px-4 lg:px-8 max-w-[1536px] mx-auto">
        ...
        <a href="{{ url('/') }}" class="flex gap-[7px] items-center shrink-0">
            <div class="h-[48px] lg:h-[73px] w-[81px] lg:w-[124px] relative shrink-0">
                <img alt="Patriot Metric" class="absolute inset-0 max-w-none object-cover lg:object-contain pointer-events-none size-full" src="{{ asset('assets/welcome/logo-patriot-metric.webp') }}" />
            </div>
            ...
            <div class="hidden lg:flex gap-[10px] items-center">
                <div class="relative size-[44px] shrink-0">
                    <img alt="UPN Veteran Jatim" class="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src="{{ asset('assets/welcome/logo-upn.webp') }}" />
                </div>
