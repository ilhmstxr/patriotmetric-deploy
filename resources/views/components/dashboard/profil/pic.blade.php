        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <div x-show="!isEditMode" class="bg-[#fafafa] border border-[#e0e0e0] rounded px-4 h-[42px] flex items-center">
                    <p class="text-[13px] font-medium text-[#45556c]" x-text="profileData.Penugasan?.nama_pic || '-'"></p>
                </div>
                {{-- EDIT --}}
            ...
            <div>
                ...
                {{-- VIEW --}}
                <div x-show="!isEditMode" class="bg-[#fafafa] border border-[#e0e0e0] rounded px-4 h-[42px] flex items-center">
                    <p class="text-[13px] font-medium text-[#45556c]" x-text="profileData.Penugasan?.jabatan_pic || '-'"></p>
                </div>
                {{-- EDIT --}}
                <input x-show="isEditMode" style="display:none;" type="text"
            ...
            <div>
                ...
                <div x-show="!isEditMode" class="bg-[#fafafa] border border-[#e0e0e0] rounded px-4 h-[42px] flex items-center gap-2">
                    ...
                    <p class="text-[13px] font-medium text-[#45556c]" x-text="profileData.Penugasan?.no_hp_pic || '-'"></p>
                </div>
                {{-- EDIT --}}
            ...
            <div>
                ...
                <div x-show="!isEditMode" class="bg-[#fafafa] border border-[#e0e0e0] rounded px-4 h-[42px] flex items-center gap-2">
                    ...
                    <p class="text-[13px] font-medium text-[#45556c]" x-text="profileData.Penugasan?.email_pic || '-'"></p>
                </div>
                {{-- EDIT --}}
                <div x-show="isEditMode" style="display:none;" class="relative">
                    <div class="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none">
