        ...
        <template x-if="!is_published">
            <div class="flex items-start gap-2 bg-white/20 border border-white/30 rounded-lg px-3 py-2 mb-3 max-w-[420px]">
                ...
                <p class="text-[11px] text-white/90 font-medium leading-relaxed">
                    <strong>Disclaimer:</strong> Skor bersifat <strong>sementara</strong> berdasarkan jawaban Anda. Skor Akhir ditentukan berdasarkan verifikasi bukti dan akan diumumkan <strong>serentak</strong> pada tanggal pengumuman.
                </p>
            </div>
        </template>
