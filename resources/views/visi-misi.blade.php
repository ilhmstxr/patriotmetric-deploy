<x-layouts.app>
    <div class="bg-white">
        ...
        <section class="py-20 bg-white">
            <div class="max-w-[896px] mx-auto px-8 text-center">
                <p class="font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[20px] text-[#d4af37] tracking-[2px] uppercase">Visi Kami</p>
                <h1 class="mt-6 font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[36px] md:text-[48px] leading-[1.25] text-[#1d293d]">
        ...
        <section class="py-20 bg-[#f8fafc]">
            <div class="max-w-[1152px] mx-auto px-8">
                        ...
                        <div class="relative">
                            <div class="bg-white rounded-full shadow-sm size-12 flex items-center justify-center mb-6">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M9 18L15 12L9 6" stroke="#1B5E20" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                </svg>
                            </div>
