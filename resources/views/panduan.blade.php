            ...
            <div class="flex-1 w-full pb-16">
                ...
                <div x-show="activeTab === 'pedoman'" x-transition.opacity style="display: none;">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                        ...
                        <a href="{{ asset('assets/documents/PEDOMAN-UPN PATRIOT METRIC 2026 v2.pdf') }}" target="_blank" download class="inline-flex items-center justify-center gap-2 bg-[#1b5e20] hover:bg-[#15461c] text-white font-bold text-[14px] px-6 py-2.5 rounded-lg transition-all shrink-0 shadow-sm">
                    ...
                    <div class="w-full bg-[#f8fafc] border border-[#cbd5e1] overflow-hidden shadow-sm" style="height: 100vh; min-height: 600px;">
                        <iframe src="{{ asset('assets/documents/PEDOMAN-UPN PATRIOT METRIC 2026 v2.pdf') }}" width="100%" height="100%" style="border: none;">
