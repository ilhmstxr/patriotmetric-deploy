...
<x-layouts.app>
    <div x-data="{ activeTab: 'panduan' }" class="bg-white min-h-screen">
        ...
        <div class="max-w-[1200px] mx-auto px-4 md:px-8 py-12 flex flex-col md:flex-row gap-8 lg:gap-16 items-stretch">
            ...
            {{-- Sidebar Plain --}}
            <div class="w-full md:w-[240px] shrink-0 md:border-r-2 border-[#e2e8f0] pr-0 md:pr-6 mb-6 md:mb-0">
                <div class="flex flex-row md:flex-col overflow-x-auto gap-6 md:gap-2 border-b md:border-b-0 border-[#e2e8f0]">
                    <button @click="activeTab = 'panduan'" 
                            :class="activeTab === 'panduan' ? 'text-[#1b5e20] font-bold border-b-2 md:border-b-0 md:border-l-2 border-[#1b5e20] md:pl-3 pb-2 md:pb-0' : 'text-[#64748b] hover:text-[#1d293d] border-b-2 md:border-b-0 md:border-l-2 border-transparent md:pl-3 pb-2 md:pb-0'"
                            class="text-left text-[16px] md:py-2 transition-colors whitespace-nowrap">
                        Panduan
                    </button>
                    <button @click="activeTab = 'pedoman'" 
                            :class="activeTab === 'pedoman' ? 'text-[#1b5e20] font-bold border-b-2 md:border-b-0 md:border-l-2 border-[#1b5e20] md:pl-3 pb-2 md:pb-0' : 'text-[#64748b] hover:text-[#1d293d] border-b-2 md:border-b-0 md:border-l-2 border-transparent md:pl-3 pb-2 md:pb-0'"
                            class="text-left text-[16px] md:py-2 transition-colors whitespace-nowrap">
                         Pedoman
                    </button>
                </div>
