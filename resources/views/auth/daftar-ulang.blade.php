        ...
        <div class="max-w-[1536px] mx-auto flex items-center justify-between h-[65px] px-[24px]">
          ...
          <div class="hidden md:flex items-center gap-[12px]">
            ...
            <div :class="activeSection === 2 ? 'text-[#1b5e20]' : 'text-[#94a3b8]'" class="flex items-center gap-[8px] transition-colors">
              ...
              <span class="font-semibold text-[14px]">Profil Institusi</span>
            </div>
          </div>
        </div>
      </header>
          ...
          <form @submit.prevent="isSubmitting = true; setTimeout(() => { window.location.href = '{{ route('dashboard.index') }}' }, 1500)" class="bg-white rounded-[20px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#e2e8f0] overflow-hidden">
            ...
            <div class="p-[32px] md:p-[48px]">
              ...
              <div x-show="activeSection === 1" x-transition.opacity.duration.500ms class="space-y-[32px]">
                ...
                <div class="flex flex-col gap-[8px]">
                  ...
                  <a href="https://bit.ly/TemplateSuratPernyataanUPNJatimPatriotMetric" target="_blank" class="text-[#1b5e20] text-[13px] font-medium hover:underline flex items-center gap-[4px] w-fit">
                    <svg class="w-[14px] h-[14px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg> 
                  ...
                  <div class="mt-[4px] border-2 border-dashed border-[#cbd5e1] rounded-[12px] p-[24px] hover:border-[#1b5e20] hover:bg-[#f8fafc] transition-all group flex flex-col items-center justify-center text-center cursor-pointer relative overflow-hidden bg-white">
                    ...
                    <div class="bg-[#f1f5f9] p-[12px] rounded-full group-hover:bg-[#e0f2fe] transition-colors mb-[12px]">
                      <svg class="w-[24px] h-[24px] text-[#64748b] group-hover:text-[#1b5e20]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg>
                    </div>
                  ...
                  <div class="flex items-start gap-[6px] mt-[2px] bg-amber-50 p-[8px] rounded-[6px] border border-amber-100">
                    <svg class="w-[14px] h-[14px] text-amber-600 mt-[2px] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
              ...
              <div x-show="activeSection === 2" style="display: none;" x-transition.opacity.duration.500ms class="space-y-[32px]">
                <div class="pb-[16px] border-b border-[#e2e8f0] mb-[32px]">
                  <h2 class="text-[20px] font-bold text-[#1d293d]">Bagian 2: Profil & Informasi Institusi</h2>
                  <p class="text-[#64748b] text-[14px] mt-[4px]">Lengkapi data identitas dan statistik perguruan tinggi.</p>
                </div>
                ...
                <div class="flex flex-col gap-[8px]">
                  ...
                  <div class="mt-[4px] border-2 border-dashed border-[#cbd5e1] rounded-[12px] p-[24px] hover:border-[#1b5e20] hover:bg-[#f8fafc] transition-all group flex flex-col items-center justify-center text-center cursor-pointer relative overflow-hidden bg-white">
                    ...
                    <div class="bg-[#f1f5f9] p-[12px] rounded-full group-hover:bg-[#e0f2fe] transition-colors mb-[12px]">
                      <svg class="w-[24px] h-[24px] text-[#64748b] group-hover:text-[#0ea5e9]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                    </div>
                    <p class="font-medium text-[#1d293d] text-[14px] mb-[4px]">Klik untuk mengunggah atau seret file ke sini</p>
                ...
                <div class="grid grid-cols-1 gap-[24px]">
                  <div class="flex flex-col gap-[8px]">
                    <label class="font-semibold text-[#1d293d] text-[14px]">6. Visi Perguruan Tinggi <span class="text-red-500">*</span></label>
                    <textarea required rows="4" class="w-full border border-[#cbd5e1] rounded-[10px] p-[16px] focus:outline-none focus:border-[#1b5e20] focus:ring-4 focus:ring-[#1b5e20]/10 text-[14px] resize-y placeholder:text-[#94a3b8]" placeholder="Tuliskan Visi Perguruan Tinggi..."></textarea>
                  </div>

                  <div class="flex flex-col gap-[8px]">
                    <label class="font-semibold text-[#1d293d] text-[14px]">7. Misi Perguruan Tinggi <span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-[24px]">
                  <div class="flex flex-col gap-[8px]">
                    <label class="font-semibold text-[#1d293d] text-[14px]">8. Jumlah Dosen <span class="text-red-500">*</span></label>
                  ...
                  <div class="flex flex-col gap-[8px]">
                    <label class="font-semibold text-[#1d293d] text-[14px]">9. Jumlah Tenaga Akademik <span class="text-red-500">*</span></label>
                  ...
                  <div class="flex flex-col gap-[8px] md:col-span-2">
                    <label class="font-semibold text-[#1d293d] text-[14px]">10. Jumlah Mahasiswa <span class="text-red-500">*</span></label>
                  ...
                  <div class="flex flex-col gap-[8px]">
                    <label class="font-semibold text-[#1d293d] text-[14px]">11. Jumlah Fakultas <span class="text-red-500">*</span></label>
                  ...
                  <div class="flex flex-col gap-[8px]">
                    <label class="font-semibold text-[#1d293d] text-[14px]">12. Jumlah Program Studi <span class="text-red-500">*</span></label>
                ...
                <div class="flex flex-col gap-[8px]">
                  <label class="font-semibold text-[#1d293d] text-[14px]">
                    13. Struktur Organisasi Perguruan Tinggi <span class="text-red-500">*</span>
                  </label>
                  <div class="mt-[4px] border-2 border-dashed border-[#cbd5e1] rounded-[12px] p-[24px] hover:border-[#1b5e20] hover:bg-[#f8fafc] transition-all group flex flex-col items-center justify-center text-center cursor-pointer relative overflow-hidden bg-white">
                    <input type="file" accept=".pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" required />
                    <div class="bg-[#f1f5f9] p-[12px] rounded-full group-hover:bg-[#e0f2fe] transition-colors mb-[12px]">
                ...
                <div class="flex flex-col gap-[8px]">
                  <label class="font-semibold text-[#1d293d] text-[14px]">
                    14. SK Tim Pemeringkatan UPN Jatim Patriot Metric <span class="text-red-500">*</span>
                  </label>
                  <div class="mt-[4px] border-2 border-dashed border-[#cbd5e1] rounded-[12px] p-[24px] hover:border-[#1b5e20] hover:bg-[#f8fafc] transition-all group flex flex-col items-center justify-center text-center cursor-pointer relative overflow-hidden bg-white">
                    <input type="file" accept=".pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" required />
                    <div class="bg-[#f1f5f9] p-[12px] rounded-full group-hover:bg-[#e0f2fe] transition-colors mb-[12px]">
                ...
                <div class="pt-[32px] mt-[16px] border-t border-[#e2e8f0] flex flex-col md:flex-row gap-[16px] items-center justify-between">
                  ...
                  >
                    ...
                    <template x-if="!isSubmitting">
                      <div class="flex items-center gap-2">
                        <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"></path></svg>
                        Submit Pendaftaran
                      </div>
                    </template>
                  </button>
