(async () => {
    ...
    console.log(`%c[Start] Menemukan ${questions.length} indikator rubrik. Mulai mengisi skor reviewer secara otomatis (nilai rata-rata kecil)...`, "color: #1b5e20; font-weight: bold; font-size: 14px;");

    for (let i = 0; i < questions.length; i++) {
        const q = questions[i];
        
        // 1. Generate skor acak antara 1 dan 2 (nilai kecil)
